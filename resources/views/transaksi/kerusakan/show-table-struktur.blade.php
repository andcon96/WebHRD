        ...
        <tbody id="edittable">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" class="form-control" name="mekanik_desc[]" value="{{$datas->kerusakan_mekanik}}" readonly>
                </td>
            </tr>
            @empty
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" class="form-control" name="mekanik_desc[]" readonly>
                    </td>
                </tr>
                @empty
                <tr>
