...
@section('content')
<form action="/updatesj" method="POST" id="submit">
    @method('POST')
    @csrf
    <div class="row">
        ...
        <div class="form-group row col-md-12">
            ...
            <label for="duedate" class="col-md-2 col-form-label text-md-right">History & Pelaporan SJ</label>
        <div class="form-group row col-md-12">
            @include('transaksi.suratjalan.laporsj-table-history')
        </div>
        <div class="form-group row col-md-12">
